...
2. Each generator of the free group (and thus any word) is represented by a function on the set of all reduced words to itself.
   ...
   The operation of "concatenate and reduce" in the free group corresponds exactly to the composition of these permutation functions.

   Since the composition of functions is associative, the corresponding free group product must also be associative. 
