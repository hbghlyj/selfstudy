...
- $H_1(X) = \mathbb{Z}_n$ since $`\ker(\partial_1)=C_1=\langle A,R,S_i\rangle`$, and $`H_1(X)=\langle A,R,S_i\rangle/\langle- A - S_i + S_{i-1},R + S_i - S_{i-1}\rangle=\langle A,R,S_i\rangle/\langle- A - S_i + S_{i-1},R-A\rangle=\langle A,S_i\rangle/\langle- A - S_i + S_{i-1}\rangle=\langle A\rangle/\langle nA\rangle`$
