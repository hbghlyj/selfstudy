...
By the Fundamental Theorem of Finite Abelian Groups, any finite abelian group $G$ can be expressed as a direct sum of cyclic groups of prime power order. If $G$ is not cyclic, then it must have at least two cyclic components in its decomposition. Let these components be $\mathbb{Z}_{p^m}$ and $\mathbb{Z_{p^n}}$ for some prime $p$ and integers $m, n \geq 1$. The subgroup generated by the elements of order $p$ in these components is isomorphic to $\mathbb{Z}_p \oplus \mathbb{Z}_p$. Thus, $G$ contains a subgroup isomorphic to $\mathbb{Z}_p \oplus \mathbb{Z}_p$.
