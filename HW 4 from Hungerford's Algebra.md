...
2. To find the isomorphism class of $G/H$, we analyze the relations in the quotient group. Let $e_1=(1,0,0), e_2=(0,1,0), e_3=(0,0,1)$ be the standard generators. In $G/H$, we have the relations from $H$: $(1,1,1)=e_1+e_2+e_3=0$ and $(1,2,3)=e_1+2e_2+3e_3=0$. Subtracting these gives $e_2+2e_3=0$, so $e_2=-2e_3$. Substituting back gives $e_1-2e_3+e_3=0$, so $e_1=e_3$. The relations from $G$ are $10e_2=0$ and $100e_3=0$. In terms of $e_3$, the first relation becomes $10(-2e_3)=-20e_3=0$. So $G/H$ is generated by the coset of $e_3$ with relations $20e_3=0$ and $100e_3=0$. This implies the order of the generator is $\gcd(20,100)=20$. Therefore, $G/H \cong \mathbb{Z}_{20}$.
