...
1. Subtracting $(1,1,1)$ from $(1,2,3)$ gives $(0,1,2)$. Thus, $H$ is generated by $(1,1,1)$ and $(0,1,2)$. The element $(1,1,1)$ has infinite order since its first component is in $\mathbb{Z}$. The element $(0,1,2)$ has order 10 since its second component is in $\mathbb{Z}/10\mathbb{Z}$. Therefore, $H \cong \mathbb{Z} \oplus \mathbb{Z}/10\mathbb{Z}$.
2. To find the isomorphism class of $G / H$, we first note that $G$ is generated by $(1,0,0)$, $(0,1,0)$, and $(0,0,1)$. The subgroup $H$ contains $(1,1,1)$ and $(0,1,2)$.
    
    The quotient group $G / H≅ \mathbb{Z}/\langle1\rangle \oplus (\mathbb{Z}/10\mathbb{Z})/\langle1\rangle \oplus (\mathbb{Z}/100\mathbb{Z})\cong \mathbb{Z}/100\mathbb{Z}$.
