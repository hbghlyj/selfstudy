...
Now, $xy = (g^m c_1)(g^n c_2) = g^{m+n} c_1 c_2$ since $c_1$ and $c_2$ commute with all elements of $G$.

Similarly, $yx = (g^n c_2)(g^m c_1) = g^{n+m} c_2 c_1$.

Since $c_1 c_2 = c_2 c_1$, we have $xy = yx$. Thus, $G$ is abelian.
