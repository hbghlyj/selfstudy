...
The group $H_n(X^n, X^{n-1})$ is a free abelian group, generated by the $n$-cells of $X$. The kernel of $\partial_n$ is a subgroup of this free abelian group. Since any subgroup of a free abelian group is also free, $\ker(\partial_n)$ is free. Therefore, $H_n(X^n)$, being isomorphic to $\ker(\partial_n)$, is free abelian.
