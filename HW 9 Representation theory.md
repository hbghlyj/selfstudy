...
The matrices in such representations are permutation matrices (containing only 0s and 1s).

The trace of a permutation matrix counts the number of 1s on the diagonal, which corresponds exactly to the number of fixed points of the action.
