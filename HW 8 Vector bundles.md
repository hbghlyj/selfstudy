...
Consider the Möbius bundle $S \rightarrow S^1$ constructed as a subbundle of the trivial rank 2 bundle $E = S^1 \times \mathbb{R}^2$.

The fiber of $S$ over a point $p = e^{i\theta} \in S^1$ is the line $S_p$ in $\mathbb{R}^2$ spanned by the vector $(\cos(\theta/2), \sin(\theta/2))$.
