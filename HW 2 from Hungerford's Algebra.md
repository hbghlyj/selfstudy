...
- The entire group $D_n$.
- The cyclic subgroup generated by the rotation $r$, denoted $\langle r \rangle$, which is normal in $D_n$.
- If $n$ is even, the subgroup generated by $r^{n/2}$, denoted $\langle r^{n/2} \rangle$, is also normal in $D_n$.
- For each divisor $d$ of $n$, the subgroup generated by $r^d$, denoted $\langle r^d \rangle$, is normal in $D_n$.
- If $n$ is even, the subgroup generated by $r^{n/2}$ and a reflection, denoted $\langle r^{n/2}, s \rangle$, is also normal in $D_n$.
