...
$\frac{du}{ds} = u + 1 \Rightarrow \frac{du}{u + 1} = ds \Rightarrow \ln|u + 1| = s + D_1 \Rightarrow u(s) = D_2 e^s - 1$.

$\frac{dv}{ds} = v + 1 \Rightarrow \frac{dv}{v + 1} = ds \Rightarrow \ln|v + 1| = s + D_3 \Rightarrow v(s) = D_4 e^s - 1$.
