...
$(f \wedge g)(v_1,\ldots, v_{k + l}) = \sum_{Sh(k,l)} \ \sigma} \operatorname{sgn}(\sigma) 
f(v_{\sigma(1)},\ldots, v_{\sigma (k)})g(v_{\sigma_{(k + 1)}}, \ldots, v_{\sigma_{k + l}})$ where $Sh(k,l)=S_{k+l}/(S_k\times S_l)$ denotes shuffles,
