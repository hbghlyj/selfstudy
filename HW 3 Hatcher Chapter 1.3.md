...
Each extra unit of period in the $x$-direction adds one more handle (successive copies along $x$ glue by a tube), increasing the genus by $1$. Thus the resulting boundary is connected and has genus $g$.
