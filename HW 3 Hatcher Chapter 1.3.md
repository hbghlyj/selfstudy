...
The period in $x$-direction adds $g-2$ handle, the periods in $y$ and $z$ directions increasing the genus by $1$, thus the resulting boundary is connected and has genus $g$.
