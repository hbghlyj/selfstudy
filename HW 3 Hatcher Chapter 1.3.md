...
For $n=2$ and $g=1$ we can construct such a covering space explicitly: $\mathbb{R}^2$ quotient by translations by a rank 2 lattice, giving the torus $T^2$.

For $n=3$ and $g \geq 3$, we can construct the covering space explicitly as a subspace of $\mathbb{R}^3$. The strategy is to first realize the base space $M_g$ as a surface embedded in a specific 3-torus, $T^3_L = \mathbb{R}^3/L$, where $L$ is the lattice of translations generated by $(g-2,0,0), (0,1,0), (0,0,1)$. The desired covering space is then the lift of this embedded surface to $\mathbb{R}^3$ (the universal cover of $T^3_L$). This lifted surface is periodic with respect to the lattice $L \cong \mathbb{Z}^3$, which acts as the group of deck transformations.

Work in the quotient $T^3=\mathbb{R}^3/\langle(g-2,0,0),(0,1,0),(0,0,1)\rangle$. The $\mathbb Z^3$–periodic “hollow cube” has boundary made of the six outer faces at $\{x,y,z\}\equiv 0\pmod 1$ and the six inner faces at $\{x,y,z\}\equiv \tfrac12 \pmod 1$. In $T^3$ these glue into a connected polyhedral surface separating the “inner” and “outer” labyrinths. For $g=3$ (i.e. period $1$ in $x$ too) this is the standard genus-$3$ Heegaard surface of the 3-torus. Each extra unit of period in the $x$-direction adds one more handle (successive copies along $x$ glue by a tube), increasing the genus by $1$. Thus in general the resulting boundary is connected and has genus $g$.
