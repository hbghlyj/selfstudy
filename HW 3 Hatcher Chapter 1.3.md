...
For $n=3$ and $g \geq 3$, we can construct such a covering space explicitly: Consider the 1-periodic hollow cube $[-1,1]^3 \setminus (-\frac{1}{2}, \frac{1}{2})^3 \pmod 1$ quotiented by a subgroup of translations generated by $(g-2,0,0), (0,1,0), (0,0,1)$. The resulting space is a connected normal covering space of a surface of genus $g$ with deck transformation group $\mathbb{Z}^3$. The boundary of the resulting space is a single closed orientable surface of genus $g$.
