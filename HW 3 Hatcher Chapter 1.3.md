...
The periods in the $x,y$ and $z$ directions each contribute $1$ to the genus. Thus, $M_3$ is this embedded surface quotiented by the subgroup of $\mathbb Z^3$  generated by $(1,0,0), (0,1,0), (0,0,1)$ acting by translations.

It is possible to attach extra handles to the surfaces, producing higher-genus minimal surface families.
