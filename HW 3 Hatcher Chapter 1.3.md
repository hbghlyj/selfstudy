...
For the second part of the problem (a sphere and a circle intersecting it in two points), we can construct a similar covering space $\tilde{X}$ consisting of infinitely many copies of $S^2$ arranged in a tree-like structure, where each sphere is attached to four others.
