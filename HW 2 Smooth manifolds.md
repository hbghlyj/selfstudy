...
Compactness: the map $\pi:S^{2n+1}\to\mathbb{CP}^n$, $\pi(z)=[z]$ is continuous and surjective, and $S^{2n+1}$ is compact (one-point compactification of $\mathbb{C}^n$). Hence $\mathbb{CP}^n$ is compact.
